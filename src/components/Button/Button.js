...
const normalStyles = css`
  ...
  &:hover {
    cursor: pointer;
    background-color: ${props => themeGet.colorShade(props.color, 0.05)};
  }

  &:focus {
    box-shadow: 0px 0px 0px 2px ${props => themeGet.colorShadeOrTint(props.color, 0.05, 0.7)};
  }
`

const disabledStyles = css`
  color: ${props => themeGet.colorText(props.color, 0.5)};
  background-color: ${props => themeGet.colorTint(props.color, 0.5)};
`
